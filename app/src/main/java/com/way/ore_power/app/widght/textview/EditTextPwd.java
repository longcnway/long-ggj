package com.way.ore_power.app.widght.textview;
 ...
 * @Description
 */
public class EditTextPwd extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.icon_eye_pwd);
        }
        mClearDrawable.setBounds(0, 0, 54, 36);
